...
public class Main {
    private static Quiz firstQuestion = new Quiz("Who was the lead singer with the 1970s pop group, Slade?", "D. Ritchie", "B. Stroustrup", "P. Noone", "B. Eich", "P. Noone");
    private static Quiz secondQuestion = new Quiz("In what year did the Beatles first leave for the United States?", "1964", "2001", "1999", "1965", "1964");
    private static Quiz thirdQuestion = new Quiz("In what year did the Titanic sink?", "2005", "1912", "1850", "1895", "1912");
    private static Quiz fourthQuestion = new Quiz("What's the name of Barbie, full name?", "Martina Shaw", "Jamie Oliver", ". Lewis Collins", "Barbara Millicent", "Barbara Millicent Roberts");
    private static Quiz fifthQuestion = new Quiz("What is the capital of Romania?", "Viena", "Bucuresti", "Berlin", "Madrid", "Bucuresti");
